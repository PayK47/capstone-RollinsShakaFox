...
function KeyWest() {
  const beachName = "key-west"; // Hardcoded for this specific page
  const [beachData, setBeachData] = useState(null);
  const [loading, setLoading] = useState(true);
  const [error, setError] = useState(null);
  const [currentPhotoIndex, setCurrentPhotoIndex] = useState(0); // State for photo carousel

  const mainPhoto = '/images/KeyWest1.jpg'; // Main image to display
    ...
    <div className="beach-detail-container">
      ...
      <div className="top-section">
        ...
        <div className="main-photo">
          <a
            href="https://www.google.com/maps/place/Key+West,+FL"
            target="_blank"
        ...
        <div className="photo-carousel">
          <img
            ...
            alt={`Key West ${currentPhotoIndex + 2}`}
